        ...
        <main class="mdl-layout__content_auth">
            <div class="mdl-card mdl-shadow--2dp">
                ...
                <div class="mdl-card__actions mdl-card--border">
                    ...
                    {!! HTML::link(route('password.request'), trans('auth.forgot'), array('id' => 'forgot', 'class' => 'ub_font_sz_12 mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect left')) !!}
                    {!! HTML::link(url('/register'), trans('auth.register'), array('id' => 'register', 'class' => 'ub_font_sz_12 mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect right')) !!}
