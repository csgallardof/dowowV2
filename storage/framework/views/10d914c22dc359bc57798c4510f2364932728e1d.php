        ...
        <div class="table-responsive material-table inverse">
            <table class="mdl-color--grey-700 mdl-color-text--white mdl-data-table-block mdl-js-data-table data-table full-span table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $local; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <?php echo $__env->make('locals.partials.task-row', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
