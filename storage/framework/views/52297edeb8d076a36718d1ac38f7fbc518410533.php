...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mdl-layout mdl-js-layout mdl-color--white mdl-auth-form">

        <img class="ub_dowow_logo_login" src="<?php echo e(url('images/logos/dowow.png')); ?>" width="20%" />

        <main class="mdl-layout__content_auth">
            <div class="mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title mdl-color--blue-600 mdl-color-text--white">
                ...
                <div class="mdl-card__supporting-text">
                    ...
                    <?php echo Form::open(['url' => 'login', 'method' => 'POST', 'class' => '', 'id' => 'login', 'role' => 'form']); ?>
                        ...
                        <?php echo Form::button('<span class="mdl-spinner-text">'.trans('auth.login').'</span><div class="mdl-spinner mdl-spinner--single-color mdl-js-spinner mdl-color-text--white mdl-color-white"></div>', array('class' => 'mdl-button mdl-js-button mdl-js-ripple-effect center mdl-color--blue-600 mdl-color-text--white mdl-button--raised full-span margin-bottom-1 margin-top-2','type' => 'submit','id' => 'submit')); ?>
                ...
                <div class="mdl-card__actions mdl-card--border">
                    ...
                    <?php echo HTML::link(route('password.request'), trans('auth.forgot'), array('id' => 'forgot', 'class' => 'ub_font_sz_12 mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect left')); ?>

                    <?php echo HTML::link(url('/register'), trans('auth.register'), array('id' => 'register', 'class' => 'ub_font_sz_12 mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect right')); ?>
