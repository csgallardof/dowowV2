            ...
            <table id="user_table" class="mdl-data-table mdl-js-data-table data-table" cellspacing="0" width="100%">
              ...
              <tbody>
                    <?php $__currentLoopData = $locals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $local): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="mdl-data-table__cell--non-numeric"><a href="<?php echo e(URL::to('local/' . $local->id)); ?>"><?php echo e($local->id); ?></a></td>
                            <td class="mdl-data-table__cell--non-numeric"><a href="<?php echo e(URL::to('local/' . $local->id)); ?>"><?php echo e($local->nombre_locals); ?> </a></td>
                           
                            <td class="mdl-data-table__cell--non-numeric mdl-layout--large-screen-only"><a href="<?php echo e(URL::to('local/' . $local->id)); ?>"><?php echo e($local->descripcion_locals); ?> </a></td>
                            
                            <td class="mdl-data-table__cell--non-numeric mdl-layout--large-screen-only"><a href="<?php echo e(URL::to('local/' . $local->id)); ?>"><?php echo e($local->created_at); ?> </a></td>
                            <td class="mdl-data-table__cell--non-numeric mdl-layout--large-screen-only"><a href="<?php echo e(URL::to('local/' . $local->id)); ?>"><?php echo e($local->updated_at); ?> </a></td>
                            <td class="mdl-data-table__cell--non-numeric">


                                
                                <a href="/profile/<?php echo e($local->nombre_locals); ?>" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="View User Profile">
